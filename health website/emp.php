...
<div class="search">
<br>
<form method='post' action='eddemp.php'>
	<input type='text' title='Enter employee name  ' name='search' id="text" required>	<input type='submit' name='sear' value= '  Search  ' id="ok" > 
	</form>
</div>	
...
$result="SELECT nameEmp FROM employees";
$query=mysqli_query($con,$result);
 if(mysqli_num_rows($query)>=1){
		    echo' <center>';
		   echo"<h2 > Employees Name:</h2><br><br>";
	   foreach($query as $results){
		   
		   echo"<table><tr><td><h4>";
		 echo $results['nameEmp']."<h4>";
			echo"</td></tr></table>";
	   }
			 echo' </center>';
...
?>
	...
	<form method="post" action="insertemployee.html">
		...
		<input type="submit" value="Insert new employee" name="insert" id="but" >
